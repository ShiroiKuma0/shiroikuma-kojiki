...
object AutomationCallers {
    ...
    private fun signingSha256(context: Context, pkg: String): String? = runCatching {
        ...
        // `signingInfo` and GET_SIGNING_CERTIFICATES are API 28, and this app's minSdk is 23. On a
        // 23–27 device the flag is accepted and `signingInfo` comes back null, so WITHOUT this
